    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <div class="img_container">
          <div class="img-box">
            <img src="<?= ASSET_URL ?>images/slider-bg.jpg" class="" alt="...">
          </div>
        </div>
      </div>
...
<section class="about_section layout_padding ">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <div class="img-box">
          <img src="<?= ASSET_URL ?>images/about-img.jpg" alt="">
        </div>
      </div>
      <div class="col-md-6">
        <div class="detail-box">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class=" col-sm-8 col-md-6 px-0">
        <div class="img-box">
          <img src="<?= ASSET_URL ?>images/g1.jpg" alt="">
          <a href="<?= ASSET_URL ?>images/g1.jpg" data-toggle="lightbox" data-gallery="gallery">
      ...
      <div class="col-sm-4 col-md-3 px-0">
        <div class="img-box">
          <img src="<?= ASSET_URL ?>images/g2.jpg" alt="">
          <a href="<?= ASSET_URL ?>images/g2.jpg" data-toggle="lightbox" data-gallery="gallery">
            <i class="fa fa-picture-o" aria-hidden="true"></i>
          </a>
        </div>
      </div>
      <div class="col-sm-6 col-md-3 px-0">
        <div class="img-box">
          <img src="<?= ASSET_URL ?>images/g3.jpg" alt="">
          <a href="<?= ASSET_URL ?>images/g3.jpg" data-toggle="lightbox" data-gallery="gallery">
            <i class="fa fa-picture-o" aria-hidden="true"></i>
          </a>
        </div>
      </div>
      <div class="col-sm-6 col-md-3 px-0">
        <div class="img-box">
          <img src="<?= ASSET_URL ?>images/g4.jpg" alt="">
          <a href="<?= ASSET_URL ?>images/g4.jpg" data-toggle="lightbox" data-gallery="gallery">
            <i class="fa fa-picture-o" aria-hidden="true"></i>
          </a>
        </div>
      </div>
      <div class="col-sm-4 col-md-3 px-0">
        <div class="img-box">
          <img src="<?= ASSET_URL ?>images/g5.jpg" alt="">
          <a href="<?= ASSET_URL ?>images/g5.jpg" data-toggle="lightbox" data-gallery="gallery">
            <i class="fa fa-picture-o" aria-hidden="true"></i>
          </a>
        </div>
      </div>
      <div class="col-sm-8 col-md-6 px-0">
        <div class="img-box">
          <img src="<?= ASSET_URL ?>images/g6.jpg" alt="">
          <a href="<?= ASSET_URL ?>images/g6.jpg" data-toggle="lightbox" data-gallery="gallery">
            <i class="fa fa-picture-o" aria-hidden="true"></i>
          </a>
        </div>
      </div>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-lg-6 ">
        <div class="box">
          <div class="img-box">
            <img src="<?= ASSET_URL ?>images/b1.jpg" alt="">
          </div>
          <div class="detail-box">
            <h5>
      ...
      <div class="col-lg-6 ">
        <div class="box">
          <div class="img-box">
            <img src="<?= ASSET_URL ?>images/b2.jpg" alt="">
          </div>
          <div class="detail-box">
            <h5>
        ...
        <div class="carousel-item active">
          <div class="row">
            <div class="col-md-11 col-lg-10 mx-auto">
              <div class="box">
                <div class="img-box">
                  <img src="<?= ASSET_URL ?>images/client.jpg" alt="" />
                </div>
                <div class="detail-box">
                  <div class="name">
                    <h6>
